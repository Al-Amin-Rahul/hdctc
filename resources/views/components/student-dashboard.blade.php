<div class="wrap shadow rounded" id="student-menu">
    <ul class="list-group">
        ...
        <a class="text-white text-center" target="_blank" href="{{ route("manage-student",['id' => session('student_id')]) }}"><li class="list-group-item bg-dark border-rds">Manage Student</li></a>
